...
\begin{figure}[t]
  \centering
  \includegraphics[width=1\columnwidth]{best_model/predictions_scatter.png}
  \caption{Figure caption.}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=1\columnwidth]{best_model/disruption_time_diff.png}
  \caption{Figure caption.}
