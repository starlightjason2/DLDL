...
qsub \
  ...
  -v "PROJECT_ROOT=$PROJECT_ROOT,DLDL_HPTUNE_DIR=$HPTUNE_DIR,HPTUNE_CONTROLLER_NODES=$HPTUNE_CONTROLLER_NODES,HPTUNE_TRIAL_NODES=$HPTUNE_TRIAL_NODES,HPTUNE_CONTROLLER_WALLTIME=$HPTUNE_CONTROLLER_WALLTIME,HPTUNE_QUEUE=$HPTUNE_QUEUE,GPUS_PER_NODE=$GPUS_PER_NODE" \
  "$CONTROLLER_SCRIPT"